...
public static class ServiceCollectionExtensions
{
  public static IServiceCollection AddMediatRAsynchronous(this IServiceCollection services,
      Action<MediatRAsynchronousServiceConfiguration> configuration)
  {
      ...
      MediatRAsynchronousServiceConfiguration configuration)
  {
    ...
    services.TryAddScoped(typeof(IInboxRepository), configuration.InboxRepository);
    services.TryAddScoped(typeof(IOutboxRepository), configuration.OutboxRepository);
